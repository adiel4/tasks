...
INTRODUCTION
  ...
  Panoply requires that a Java 9 (or later) Runtime Environment (JRE) be installed on your
...
INSTALLING AND RUNNING THE "STANDARD" PANOPLY PACKAGE
  ...
  script if you are trying to run this generic version of Panoply from the macOS Terminal
  command line.
